 ...
 * Handles customer business logic and database operations.
 */
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerResponseDTO createCustomer(CustomerRequestDTO request) {
        ...
        /*
         * VERY IMPORTANT:
         * Since customerNumber is manually assigned,
         * we must explicitly tell Spring Data JPA
         * that this entity is NEW.
         */
        customer.markAsNew();
    ...
    @Override
    public CustomerResponseDTO updateCustomer(Integer customerNumber,
    ...
    @Override
    public CustomerResponseDTO updateCreditLimit(Integer customerNumber,
    ...
    @Override
    public List<CustomerResponseDTO> searchByCountryAndCity(String country,
                                                            String city) {
