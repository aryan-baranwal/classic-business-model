...
// DB Schema: productCode varchar(15) NOT NULL, quantityOrdered int(11) NOT NULL,
//            priceEach decimal(10,2) NOT NULL, orderLineNumber smallint(6) NOT NULL
public class OrderDetailRequestDTO {

    // Matches: productCode varchar(15) NOT NULL
    // NotBlank — cannot be null or empty as per DB NOT NULL constraint
    ...
    // NotNull — cannot be null as per DB NOT NULL constraint
    // Positive — line number must be greater than zero
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderDetailRequestDTO)) return false;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(productCode, quantityOrdered, priceEach, orderLineNumber);
    }
